...
def args(arg):
	"""
	Convert stream of characters, into a list of strings with space as delimiter
	"""
	return arg.split()


def check_id(object_id):
	"""concatenates the className and id, to check if the key exists in __object/file store
	"""
